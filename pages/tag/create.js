        ...
        <MainLayout>
            ...
            <div className="min-h-screen md:px-20 pt-6">
                ...
                <div className="space-y-4">
                    <div>
                    <label for="title" className="text-lx">إسم التصنيف :</label>
                    ...
                    <label for="title" className="text-lx">إسم لطيف :</label>
                    ...
                    <div>
                    <label for="description" className="block mb-2 text-lg ">الوصف:</label>
