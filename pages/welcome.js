  ...
  <div class="container relative mx-auto">
    <div class="items-center flex flex-wrap justify-center">
      <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
        <Image src="/logo-q-01.svg" width={950} height={550} alt="logo" />
        <Link href={'/'}>
          <button  style={{ fontFamily: 'NotoBold' }} class='bg-violet-50 p-5 mt-5 w-36'>ابدأ معنا الآن</button>
        </Link>
      </div>
    </div>
        ...
        <div class="flex flex-wrap">
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                ...
                <div class="px-4 py-5 flex-auto">
                    ...
                    <h6 class="text-xl font-semibold">ماهو كيوليست</h6>
            ...
            <div class="w-full md:w-4/12 px-4 text-center">
                ...
                <div class="px-4 py-5 flex-auto">
                    ...
                    <h6 class="text-xl font-semibold font-mono">
                      I/O 
                    </h6>
                    <p class="mt-2 mb-4 text-gray-600 text-right">
                    إن كنت تتساءل عن معنى <span class='font-mono text-blue-800'>I/O</span> فهي اختصار لكلمتي  <span class='font-mono text-blue-800'>Input/Output</span> ويمكن وصفها بأسلوب تواصل أنظمة الحواسيب فيما بينها وبالعالم الخارجي أيضاً، حيث يتم ادخال المعلومات الى هذه الأنظمة لتخرج الناتج في النهاية بعد معالجة المدخلات المرسلة.
                    </p>
                </div>
                </div>
            </div>
    ...
    <footer class="p-4 bg-white sm:p-6">
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          ...
          <div><Image src="/logo-01.svg" width={100} height={100} alt="logo"/></div>
          <span class="self-center text-xl font-semibold whitespace-nowrap font-mono">BeeMedia</span>
        </div>
      </div>
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a href="https://fb.com/bemedia.it" class="text-gray-500 hover:text-gray-900">
          ...
          <a href="https://instagram.com/bemedia.it" class="text-gray-500 hover:text-gray-900">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fill-rule="evenodd"
          ...
          <a href="https://twitter.com/mansour_tech" class="text-gray-500 hover:text-gray-900">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
          ...
          <a href="https://github.com/theEngMansour" class="text-gray-500 hover:text-gray-900">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fill-rule="evenodd"
